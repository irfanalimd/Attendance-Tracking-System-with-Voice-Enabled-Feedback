...
# Family member 1
sadiq_image = face_recognition.load_image_file("images/sadiq.jpg")
sadiq_face_encoding = face_recognition.face_encodings(sadiq_image)[0]

#Family member 2

irfan_image = face_recognition.load_image_file("images/irfan.jpg")
irfan_face_encoding = face_recognition.face_encodings(irfan_image)[0]


shoaib_image = face_recognition.load_image_file("images/shoaib.jpg")
